...
BOT_TOKEN = environ.get('BOT_TOKEN', '6928071913:AAGYYmbfz7S_-Mf1UHShuH7RJGf3v30luls')
# Bot settings
...
auth_channel = environ.get('AUTH_CHANNEL', "-1001967167299")
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Forwardbot:nehalsingh969797@cluster0.znh0u0i.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Mrblackgod")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL','-1001748572062' ))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1001967167299')
...
HOW_TO_DOWNLOAD =  environ.get('HOW_TO_DOWNLOAD', 'https://youtu.be/zd7KZq-lhRU')

AUTO_DELETE_SECONDS = int(environ.get('AUTO_DELETE_SECONDS', '2000'))
